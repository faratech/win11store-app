...
The production integration supplies the catalog inline and serves built assets under `/js/Win11Store/`. This public tree contains the reusable UI, catalog types, validation, and affiliate-link helpers; host-specific XenForo deployment tooling is not included.
